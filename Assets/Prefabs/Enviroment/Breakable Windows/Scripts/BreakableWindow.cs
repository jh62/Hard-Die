        ...
        if (isBroken == false)
        {
            if (allreadyCalculated == true)
            {
                ...
                if (addTorques)
                {
                    ...
                    {
                        GameObject o = splinters[i];

                        if (o != null)
                            o.GetComponent<Rigidbody>().AddTorque(new Vector3(Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50));
                    }
                }
            }
            else
